\documentclass[thesisi,twoside]{plai}

\usepackage{tabularx}

\usepackage{lipsum}
\usepackage{tikz}
\usetikzlibrary{backgrounds,shapes.geometric,arrows,decorations,decorations.pathreplacing,fit,positioning,shapes.multipart,calc}
